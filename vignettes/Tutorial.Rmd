...
$$
\ HSI_i = \frac{{l}_{i,suitable}}{l_i} \mbox{  ;         } HSI_i = \frac{{A}_{i,suitable}}{A_i}
$$
Here ${l}_{i,suitable}$ and ${A}_{i,suitable}$ are the fractions of length/area of reach $i$ that are suitable, and are usually refferred to as weighted suitable length or weighted suitable area.
